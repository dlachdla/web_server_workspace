    ...
    <div class="w-full bg-white rounded-lg shadow my-4 sm:max-w-md xl:p-0">
        <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
            ...
            <form name="memberUpdateFrm" action="${pageContext.request.contextPath}/member/memberUpdate" method="post" class="space-y-4 md:space-y-6">
                ...
                <div>
                    <label for="birthday" value="${loginMember.birthday}" class="block mb-2 text-sm font-medium text-gray-900">생일</label>
                    <input type="date" name="birthday" id="birthday" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5">
                </div>
                <div>
                ...
                <div>
                    ...
                    <input type="text" name="phone" id="phone" value="${loginMember.phone}" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" placeholder="(-) 없이 입력하세요." required>
                </div>
                <fieldset>
...
<%--                        <c:if test="${hobby ne '운동' && hobby ne '게임' && hobby ne '영화' && hobby ne '음악'}">--%>
                ...
                <button onclick="location.href = '${pageContext.request.contextPath}/member/updatePassword';" type="button" class="text-white w-full bg-purple-400 hover:bg-purple-500 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">비밀번호 변경</button>
