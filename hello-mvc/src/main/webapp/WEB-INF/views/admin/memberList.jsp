...
<div class="p-10">
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg"><h1 class="m-4 text-xl font-bold leading-tight tracking-tight text-gray-900 md:text-2xl">
        회원관리
    </h1>
...
<%--                            ${member.regDate}--%>
                        ...
                        <%-- 1. LocalDate -> Date로 변환 (fmt:parseDate) --%>
                        <%-- 2. Date 포멧팅(fmt:formatDate) --%>
